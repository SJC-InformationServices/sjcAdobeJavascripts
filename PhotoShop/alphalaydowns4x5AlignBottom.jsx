 ...
 */
function alphalaydownalignbottom() {

    var sourcePath = '\\\\10.3.0.39\\Alpha Broder\\AutoCrop4x5AlignBottom\\IN\\';
    var DestinationPath = '\\\\10.3.0.39\\Alpha Broder\\AutoCrop4x5AlignBottom\\OUT\\';
    ...
    for (var i = 0; i < imgs.length; i++) {
        ...
        try {
            ...
            for (var y = 0; y < clippaths.length; y++) {
                p = clippaths[y];
                if (p.name == 'Path 1') {
                    p.makeSelection(3, 1, SelectionType.REPLACE);
            ...
            if (!activePath) {
                ...
                doc.crop(["0 px","0 px", doc.width, doc.height*0.88]);
                var w = doc.width;
                var h = doc.height;
                if (w > h) {

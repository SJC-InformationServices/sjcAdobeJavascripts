var filepath = "/C/Users/KevinNoseworthy/Documents/GitHub/sjcAdobeJavascripts/AlphaImageLibrary.txt"
...
while(!read_file.eof)
{
    ...
    if(count < 1000)
    {
        ...
        var folder = new Folder("/w/PNGS/" + brand);
        if(!folder.exists){
            folder.create();
        }
        var pngname = "/w/PNGS/" + brand + "/" +  basename.replace(".jpg","") + ".png"
